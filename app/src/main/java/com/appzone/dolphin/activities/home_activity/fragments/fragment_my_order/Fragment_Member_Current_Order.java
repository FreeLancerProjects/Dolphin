...
import com.appzone.dolphin.adapters.ClientCurrentOrderAdapter;
...
public class Fragment_Member_Current_Order extends Fragment {
    ...
    public static Fragment_Member_Current_Order getInstance(UserModel userModel)
    {
        Fragment_Member_Current_Order fragment_current_order = new Fragment_Member_Current_Order();
    ...
    private void initView(View view) {
        ...
        adapter = new ClientCurrentOrderAdapter(getActivity(),clientOrderModelLis);
