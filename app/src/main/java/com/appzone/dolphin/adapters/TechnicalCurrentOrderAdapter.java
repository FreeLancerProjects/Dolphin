...
import com.appzone.dolphin.activities.home_activity.fragments.fragment_my_order.Fragment_Technical_Current_Order;

import java.util.List;
import java.util.Locale;

public class TechnicalCurrentOrderAdapter extends RecyclerView.Adapter<TechnicalCurrentOrderAdapter.MyHolder> {
    ...
    public TechnicalCurrentOrderAdapter(Context context, List<TechnicalOrderModel> technicalOrderModelList,Fragment_Technical_Current_Order fragment_technical_current_order) {
        this.context = context;
        this.technicalOrderModelList = technicalOrderModelList;
        this.fragment_technical_current_order = fragment_technical_current_order;
    }
    ...
    public void onBindViewHolder(@NonNull final MyHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragment_technical_current_order.setItem(technicalOrderModel,holder.getAdapterPosition());
            }
        });
