...
import com.appzone.dolphin.activities.home_activity.fragments.fragment_my_order.Fragment_Technical_Previous_Order;

import java.util.List;
import java.util.Locale;

public class TechnicalPreviousOrderAdapter extends RecyclerView.Adapter<TechnicalPreviousOrderAdapter.MyHolder> {
    ...
    public TechnicalPreviousOrderAdapter(Context context, List<TechnicalOrderModel> technicalOrderModelList,Fragment_Technical_Previous_Order fragment_technical_previous_order) {
        this.context = context;
        this.technicalOrderModelList = technicalOrderModelList;
        this.fragment_technical_previous_order = fragment_technical_previous_order;
    }
