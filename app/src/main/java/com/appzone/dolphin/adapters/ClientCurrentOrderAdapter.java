...
public class ClientCurrentOrderAdapter extends RecyclerView.Adapter<ClientCurrentOrderAdapter.MyHolder> {

    private Context context;
    private List<ClientOrderModel> clientOrderModelList;

    public ClientCurrentOrderAdapter(Context context, List<ClientOrderModel> clientOrderModelList) {
    ...
    public MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.client_current_row,parent,false);
    ...
    public class MyHolder extends RecyclerView.ViewHolder {
        ...
        {
            Picasso.with(context).load(Uri.parse(Tags.IMAGE_PATH+clientOrderModel.getUser_photo())).into(image);
            ...
            tv_technical_name.setText(clientOrderModel.getUser_full_name());
            tv_date_time.setText(clientOrderModel.getOrder_date()+" - "+clientOrderModel.getTechnical_arrival());
        }
    }
